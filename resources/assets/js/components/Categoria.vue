        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fa fas fa-bookmark"></i> Categorías
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button v-show="accion == 0" type="button" @click="RegistrarCategoria"
                            class="btn btn-primary">Guardar </button>
                        <button v-show="accion" type="button" @click="ActualizarCategoria"
    ...
    export default {
        ...
        methods: {
            cambiarPagina(page, buscar, criterio) {
                ...
                me.ListarCategoria(page, criterio, buscar);
            },

            ListarCategoria: function(page, criterio, buscar) {
                let me = this;
                ...
                axios
                    ...
                    .then(function(response) {
                        ...
                        me.arrayDatos = respuesta.categoria.data;
        ...
        mounted() {
            ...
            this.ListarCategoria(1, this.criterio, this.buscar);
        }
    };
